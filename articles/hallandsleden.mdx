...
The feel is close to a trail like England's [Cotswold Way](https://cotswoldway.org) – clearly waymarked, easy underfoot, and never far from a village. The setting is different: forest and heath here, and the freedom to camp, where the Cotswold Way runs along a limestone escarpment through stone-built villages and inns.
